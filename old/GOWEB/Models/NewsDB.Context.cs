...
namespace GOWEB.Models
{
    ...
    public partial class greenopt_GONewsEntities : DbContext
    {
        ...
        public virtual ObjectResult<spgo_GetLatestNewsOrderByDateByMGID_Result> spgo_GetLatestNewsOrderByDateByMGID(Nullable<int> mgID)
        {
            var mgIDParameter = mgID.HasValue ?
                new ObjectParameter("mgID", mgID) :
                new ObjectParameter("mgID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spgo_GetLatestNewsOrderByDateByMGID_Result>("spgo_GetLatestNewsOrderByDateByMGID", mgIDParameter);
        }
